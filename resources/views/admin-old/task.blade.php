        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div id="listHeader">
                        <h3>List Of Task</h3>
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addTaskModal">Add
                            New Task</button>
                    </div>
                    <div class="mt-4" id="">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3 class="text-center mb-3"><u>Add New Task</u></h3>
                    <form>
                        <div class=" row">
                            <div class="form-group col-md-6">
                                <label for="">Type Id<i style="color:red">*</i></label>
                                <select type="text" class="form-control" id="">
                                    <option>TType-001</option>
                                    <option>TType-002</option>
                                    <option>TType-003</option>
                                    <option>TType-004</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">Subject Id<i style="color:red">*</i></label>
                                <select type="text" class="form-control" id="">
                                    <option>Syl-001</option>
                                    <option>Syl-002</option>
                                    <option>Syl-003</option>
                                    <option>Syl-004</option>
                                </select>
                            </div>
                        </div>
                        <div class=" row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="">Document Link<i style="color:red">*</i></label>
                                <input type="text" class="form-control" id="" placeholder="Paste Document Link">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="">Details</label>
                            <input type="text" class="form-control" id="" placeholder="Enter Details ">
                        </div>
                    ...
                    <a type="button" id="" class="btn btn-sm btn-primary moveRight" href="task.html">Submit</a>
