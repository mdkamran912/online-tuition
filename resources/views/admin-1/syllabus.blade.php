...
<body>
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="assets/images/onlineTutor_logo.png"
        ...
        <div class="container-fluid page-body-wrapper">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="candidateList.html">List</a></li>
                                <li class="nav-item"> <a class="nav-link" href="addCandidate.html">Add New</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div id="listHeader">
                        <h3>List Of Syllabus</h3>
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addSyllabusModal">Add
                            New Syllabus</button>
                    </div>
                    <div class="mt-4" id="">
                        <table class="table table-hover table-bordered ">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>Sub-001</td>
                                    <td>Number Systems, Algebra, Coordinate Geometry, Geometry, Trigonometry,
                                        Mensuration, Statistics & Probability</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Sub-002</td>
                                    <td>Basic Biology, Plant Physiology, Human Anatomy and Physiology, Population </td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Sub-003</td>
                                    <td>Periodic Properties and variations of Properties, Chemical Bonding, Coordinate
                                        Bonding, Mole Concept and Stoichiometry</td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>Sub-004</td>
                                    <td>Force, Work, Power and Energy, Light, Sound, Modern Physics</td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    <td>Sub-005</td>
                                    <td>Composition, Letter, Notice, E-mail, Unseen Prose Passage, Listening Skills,
                                        Speaking Skills</td>
                                </tr>
    ...
    <div class="modal fade" id="addSyllabusModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">

                <div class="modal-body">
                    <h3 class="text-center mb-3"><u>Add New Syllabus</u></h3>
                    <form>
                        <div class=" row">
                            <div class="form-group col-md-6">
                                ...
                                <select type="text" class="form-control" id="">
                                    ...
                                    <option>Sub-002</option>
                                    <option>Sub-003</option>
                                    <option>Sub-004</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">Name</label>
                                <input type="text" class="form-control" id="" placeholder="Enter Syllabus Details">
                            </div>
                        </div>
                    </form>
                    <a type="button" id="" class="btn btn-sm btn-primary moveRight" href="subject.html">Submit</a>
