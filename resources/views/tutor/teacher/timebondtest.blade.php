...
<body>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="mb-4 text-center">
                        <h3>Unit Test 1</h3>
                        <p>Please select any one of given options.</p>
                        <h4 class="text-danger" id="timer">Countdown Timer</h4>

                    </div>
                    <div class="contnr mb-4">
                        <div class="col">
                            <h3 id="questionBox">
                    ...
                    <a class="btn btn-sm float-right" style="background-color: green; margin-right: 75px;"
                        href="addPractice.html">Make Active</a>
                </div>
    ...
    <script>
        // Set the countdown duration to 2 hours (in milliseconds)
        ...
        const countdown = setInterval(() => {
            ...
            if (timeRemaining < 0) {
                ...
                document.getElementById("timer").textContent = "Countdown is finished!";
            }
