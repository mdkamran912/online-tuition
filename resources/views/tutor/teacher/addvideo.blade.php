...
<body>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div id="listHeader" class="mb-3">
                        ...
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addVideosModal">Add
                            Videos</button>
                    </div>
                    ...
                    <table class="table table-bordered table-hover table-responsive">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-wrap">Real Number, Euclids division lemma and problems on it
                                    complete,Finding HCF
                                    prime-factorization method</td>
                                <td>
                                    <ol>
                                        <li><a target="_blank"
                                                href="https://www.youtube.com/watch?v=KD1LI_y_iH4&ab_channel=PhysicsWallahFoundation">
                                                Link 1</a></li>
                                        <li><a target="_blank"
                                                href="https://www.youtube.com/watch?v=KD1LI_y_iH4&ab_channel=PhysicsWallahFoundation">
                                                Link 2</a></li>
                            ...
                            <tr>
                                ...
                                <td class="text-wrap">Introduction of quadratic equation and pre- requisite
                                    solving by factorization method
                                    Nature of the roots</td>
                                <td>
                                    <ol>
                            ...
                            <tr>
                                <td>3</td>
                                <td>Chemistry</td>
                                <td>Kinetic theory of matter</td>
                                <td class="text-wrap">The Kinetic Theory of Matter states that matter is a package of a
                                    large number of small particles, individual atoms, or
                                    molecules.</td>
                                <td>
                                    <ol>
                                        <li><a href="#"> Link 1</a></li>
    ...
    <!-- modal -->
    <div class="modal fade" id="addVideosModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">

                <div class="modal-body">
                    <h3 class="text-center mb-3"><u>Add New Video</u></h3>
                    ...
                    <div class=" row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="" placeholder="Enter Topc">
                        </div>
                    ...
                    <div class=" row">
                        <div class="form-group col-md-9">
                            ...
                            <input type="text" class="form-control" id="vlink" placeholder="Enter Video Link">
                        </div>

                        <div class="form-group col-md-3" style="margin-top: 37px;">
                            <button class=" btn btn-sm bg-dark" onclick="addNewLink();">Add</button>
                        </div>
                    </div>
                    ...
                    <a type="button" id="" class="btn btn-sm btn-primary moveRight" style="background-color: #198754;"
                        href="addVideo.html">Submit</a>
                    <button type="button" class="btn btn-sm btn-danger mr-1 moveRight" style="background-color:#DC3545;"
    ...
    <script>
        ...
        function addNewLink() {
            var linkObj = {};
            linkObj.vlink = $("#vlink").val();
            linkArray.push(linkObj);
            BindLinkArray();
            document.getElementById("vlink").value = "";
        }

        function BindLinkArray() {
            var p = 0;
            var strRow = "";
            for (var c = 0; c < linkArray.length; c++) {
                p++;
                strRow += `<tr>`;
                strRow += `<td >${p}</td>`;
                strRow += `<td>${linkArray[c].vlink}</td>`;
                strRow += `</tr>`;
            }
            document.getElementById("tbodyLink").innerHTML = strRow;
        }
    </script>
