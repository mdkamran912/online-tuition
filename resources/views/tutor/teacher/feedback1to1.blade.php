                    ...
                    <table class="table table-bordered table-responsive table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>William</td>
                                <td class="text-wrap">Overall I really like this class because all lectures,
                                    assignments, and tests are straight forward. A couple things I
                                    dislike about the class are that there should be more opportunities for extra credit
                                    and it would be awesome if the
                                    final was an objective essay about what we have learned in this class or what we
                                    like about the class. </td>
                                <td class="text-wrap">In publishing and graphic design, Lorem ipsum is a placeholder
                                    text commonly used to demonstrate the visual form of a
                                    document or a typeface without relying on meaningful content. Lorem ipsum may be
                                    used as a placeholder before final copy
                                    is available.</td>
                                <td>19 June 2023</td>
                            </tr>
                ...
                <div class="modal-body">
                    ...
                    <form>
                        <div class=" row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="">Student Name<i style="color:red">*</i></label>
                                <select type="text" class="form-control" id="">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" placeholder="Feedback">

                                </textarea>
                            </div>
                        </div>
                        <a type="button" id="" class="btn btn-sm btn-primary moveRight"
                            href="feedback1to1.html">Submit</a>
