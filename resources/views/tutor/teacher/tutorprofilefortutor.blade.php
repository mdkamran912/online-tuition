                            ...
                            <div class="card" style="width: 50rem; margin: 0 auto;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="ms-4 d-flex flex-column" style="width: 150px;">
                                                <img src="images/faces/face1.jpg" alt="Generic placeholder image"
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- <video width="320" height="240" controls>
                                        <source src="images/ESL Teacher Self Introduction.mp4" type="video/mp4">
                                    ...
                                    <table class="tab table-bordered" width="100%" id="">
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>william@gmail.com
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Rate:</th>
                                            <td><span>&#163;</span>120 / Hr</td>
                                        </tr>
                ...
                <div class="modal-body">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Name" value="Richard">
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="name">Qualification<i style="color:red">*</i></label>
                                <input type="text" class="form-control" id="qualification"
                                    placeholder="Enter Qualification" value="Ph.D">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control" id="" value="richard@gmail.com" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">Rate<i style="color:red">*</i></i></label>
                                <input type="text" class="form-control" id="" placeholder="Enter Rate" value="$20 / Hr"
                                    value="$20 / Hr">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="" placeholder="Enter Hedline "
                                value="I am an English teacher, with over 10 years of experience.">
                        </div>
                        <h6><u>Achievement</u></h6>
                        <div class=" row">

                            <div class="form-group col-md-4">
                                <label for="">Name<i style="color:red">*</i></label>
                                <input type="text" class="form-control" id="" placeholder="Enter Details1"
                                    value="Best Teacher Award-2020"
                                    value="I am a good English Teacher, with over 10 years' experience">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="">Description<i style="color:red">*</i></label>
                                <input type="text" class="form-control" id="" placeholder="Enter Details1"
                                    value="I got best teacher award from education council.	"
                                    value="I am a good English Teacher, with over 10 years' experience">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="">Date</label>
                                <input type="date" class="form-control" id="achDate" value="2020-03-26">
                        ...
                        <div class=" row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id=""
                                    placeholder="Enter Area Of Your Expertise." value="English">
                            </div>
                        </div>
                        <div class=" row">
                            <div class="form-group col-md-6">
