            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div id="listHeader" class="mb-3">
                        <h3>Test</h3>
                        <a class="btn btn-sm btn-primary" href="addPracticeMainPage.html">Create Test</a>
                    </div>
                    ...
                    <table class="table table-bordered table-hover ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-wrap">
                                    <ul>
                                        <li>Access the exam through the provided link</li>
                                        <li>The exam will have a predefined duration( 2 hours) which will be clearly
                                            communicated to you.</li>
                                    </ul>
                                </td>
                                <td>2 Hr</td>
                                <td><a href="timeBondTest.html"><i class="fa fa-eye"></i> Preview</a></td>
