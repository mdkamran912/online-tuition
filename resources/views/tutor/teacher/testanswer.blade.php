...
<body>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div id="listHeader">
                        <h3>List Of Test Answer</h3>
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addAnsModal">Add
                            New Answer</button>
                    </div>
                    <div class="mt-4" id="">
                    ...
                    <div class="p-5 mt-4" id="addNewForm" style="width: 35rem;">
                        ...
                        <form>
                            <div class=" row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select type="text" class="form-control" id="">
                                        <option>Ques-001</option>
                                        <option>Ques-002</option>
                                        <option>Ques-003</option>
                                        <option>Ques-004</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox"><label for=""> &nbsp; Is Correct?</label>
    ...
    <!-- container-scroller -->
    <!-- modal -->
    <div class="modal fade" id="addAnsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">

                <div class="modal-body">
                    <h3 class="text-center mb-3"><u>Add New Question</u></h3>
                    <form>
                        <div class=" row">
                            <div class="form-group col-md-6">
                                <label for="">Test Id</label>
                                <select type="text" class="form-control" id="">
                                    <option>Test-001</option>
                                    <option>Test-002</option>
                                    <option>Test-003</option>
                                    <option>Test-004</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
