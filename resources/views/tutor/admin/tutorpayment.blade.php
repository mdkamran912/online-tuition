        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <h3 class="text-center">Add Tutor Payment Details</h3>
                    ...
                    <div class="p-5 mt-4" id="addNewForm" style="width: 35rem;">
                        ...
                        <form>
                            <div class=" row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="">Candidate Id<i style="color:red">*</i></label>
                                    <select type="text" class="form-control" id="">
                                        <option>Cand-001</option>
                                        <option>Cand-002</option>
                                        <option>Cand-003</option>
                                        <option>Cand-004</option>
                                    </select>
                                </div>
                            </div>
                            <div class=" row">
                            ...
                            <div class=" row">
                                <div class="form-group col-md-6">
                                    <label for="">Date<i style="color:red">*</i></label>
                                    <input type="date" class="form-control" id="" placeholder="Enter Task Name">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="">Payment Mode<i style="color:red">*</i></label>
                                    <select type="text" class="form-control" id="">
