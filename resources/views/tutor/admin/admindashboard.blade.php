    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="adminDashboard.html"><img
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="task.html" aria-controls="form-elements">
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Welcome Dwayne Johnson</h3>
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card tale-bg">
                                <div class="card-people mt-auto">
                                    <img src="images/dashboard/educationDashboard.svg" alt="people">
                                    <div class="weather-info" style="padding:3%;">
                                        <div class="d-flex">
                                            <div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="icon-data-list">
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                <img src="images/faces/.jpg" alt="user">
                                                <div>
