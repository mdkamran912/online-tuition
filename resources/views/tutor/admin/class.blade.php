                        ...
                        <form>
                            ...
                            <div class=" row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="">Grade Id<i style="color:red">*</i></label>
                                    <select type="text" class="form-control" id="">
                                        <option>Grade-001</option>
                                        <option>Grade-002</option>
                                        <option>Grade-003</option>
                                        <option>Grade-004</option>
                                    </select>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="">One To One<i style="color:red">*</i></label>
                                    <input type="text" class="form-control" id="" placeholder="One To One">
                                </div>
                            </div>
                            ...
                            <div class=" row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="">Class Link<i style="color:red">*</i></label>
                                    <input type="text" class="form-control" id="" placeholder="Class Link">
                                </div>
                            </div>
