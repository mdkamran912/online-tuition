            ...
            <div class="main-panel">
                <div class="content-wrapper">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="mathsSyllabus.html" class="btn btn-sm btn-primary">View</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-3">
                            <div class="card">
                                <img src="images/subjects/bio.webp" class="card-img-top"
                                    alt="Fissure in Sandstone" />
                                <div class="card-body">
                                    <h5 class="card-title">Biology</h5>
                                    <p class="card-text"><b>Tutor: </b>Layla</p>
                                    <a href="mathsSyllabus.html" class="btn btn-sm btn-primary">View</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card">
                                <img src="images/subjects/french.webp" class="card-img-top"
                                    alt="Fissure in Sandstone" />
                                <div class="card-body">
                                    <h5 class="card-title">French</h5>
                                    <p class="card-text"><b>Tutor: </b>Amélie</p>
                                    <a href="#!" class="btn btn-sm btn-primary">View</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><b>Tutor: </b>Joseph</p>
                                    <a href="#!" class="btn btn-sm btn-primary">View</a>
                                </div>
                            </div>
                        </div>
