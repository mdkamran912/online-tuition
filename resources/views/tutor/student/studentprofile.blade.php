                    ...
                    <div class="card" style="width: 50rem; margin: 0 auto;">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="ms-4 d-flex flex-column" style="width: 150px;">
                                        ...
                                        <a type="button" class="btn btn-outline-dark bg-primary" href="#"
                                            style="z-index: 1;">
                                            Edit profile
                                        </a>
                                ...
                                <div class="col-9 text-left">
                                    <h2 style="margin-top: 60px;">William Horwitz</h2>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>Recipient of a scholarship</td>
                                    <td>Recipient of a scholarship from School</td>
                                    <td>26 March 2019</td>
                                </tr>
                            </table>
