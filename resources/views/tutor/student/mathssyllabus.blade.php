        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div id="listHeader">
                        <h3>Mathematics</h3>
                        <p> ICSE class 10 mathematics. (Basics to Advance)</p>
                        <P><b>Tutor:</b> Hazel</P>
                    </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <li>Real Number</li>
                                        <li>Euclids division lemma and problems on it complete</li>
                                        <li>Finding HCF prime-factorization method</li>
                                        <li>Decimal expansion of rational and irrational number with ncert solutions
                                        </li>
                                        <li>Without actually dividing finding the decimal expansion of rational number
                                        </li>

                                    </ul>

                                </td>
                                <td class="text-success"><i class="fa fa-check-circle" aria-hidden="true">Attended</i>
                                </td>
                                <td>25/05/2023 15:00 </td>
                                <td> <a href="playRecordedSession.html"> <i class="fa fa-film" aria-hidden="true"></i>
                                        Video</a>
                                </td>
                                <td> <a href="studyContent.html"> <i class="fa fa-files-o" aria-hidden="true"></i> View
                                    </a>
                                </td>
                                <td> <a href="testPractice.html"> <i class="fa fa-pencil-square-o"
                                            aria-hidden="true"></i> Practice</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        ...
                                        <li>zeroes of the polynomials (relations ship b/w zeroes and coefficient)</li>
                                        <li>Polynomial division</li>
                                    </ul>
                                </td>
                                <td class="text-success"><i class="fa fa-check-circle" aria-hidden="true">Attended</i>
                                </td>
                                <td>27/05/2023 15:00 </td>
                                <td> <a href="playRecordedSession.html"> <i class="fa fa-film" aria-hidden="true"></i>
                                        Video</a>
                                </td>
                                <td> <a href="studyContent.html"> <i class="fa fa-files-o" aria-hidden="true"></i> View
                            ...
                            <tr>
                                <th scope="row">3</th>
                                <th class="text-wrap">Pair of linear equation in two variables</th>
                                <td>
                                    <ul>
                                        <li>Introduction and pre requisite of Pair of linear equation in two variables
                                        </li>
                                        <li>substitution method and elimination method</li>
                                        <li>Solving by cross multiplication method</li>
                                        <li>Graphical method and some problems of reducible form</li>
                                    </ul>
                                </td>
                                <td class="text-success"><i class="fa fa-check-circle" aria-hidden="true">Attended</i>
                                </td>
                                <td>29/05/2023 13:00 </td>
                                <td> <a href="playRecordedSession.html"> <i class="fa fa-film" aria-hidden="true"></i>
                                        Video</a>
                                </td>
                                <td> <a href="studyContent.html"> <i class="fa fa-files-o" aria-hidden="true"></i> View
                            ...
                            <tr>
                                <th scope="row">4</th>
                                <th>Quadratic Equation</th>
                                <td>
                                    <ul>
                                        <li>Introduction of quadratic equation and pre- requisite</li>
                                        <li>solving by factorization method</li>
                                        <li>Nature of the roots</li>
                                        <li>Solving by quadratic formula and completing square method</li>
                                    </ul>
                                </td>
                                <td class="text-danger"><i class="fa fa-times-circle" aria-hidden="true">Not
                                        Attended</i>
                                </td>
                                <td>01/06/2023 14:00 </td>
                                <td> <a href="playRecordedSession.html" style="pointer-events: none; color: darkgrey;">
                                        <i class="fa fa-film" aria-hidden="true"></i> Video</a>
                                </td>

                                <td> <a href="studyContent.html" style="pointer-events: none; color: darkgrey;"> <i
                                            class="fa fa-files-o" aria-hidden="true"></i> View</a>
                                </td>
                                <td> <a href="#" style="pointer-events: none; color: darkgrey;"> <i
                                            class="fa fa-pencil-square-o" aria-hidden="true"></i> Practice</a>
                                </td>
