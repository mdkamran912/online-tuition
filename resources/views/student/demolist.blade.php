                               ...
                               @foreach ($demo as $demo)
                                  <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="democancel/{{$demo->demo_id}}"><button class="btn btn-sm btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Cancel</button></a></td>
                                    @elseif ($demo->status == 2)
                                    <td>
                                        {{-- <a href="demoreschedule"><button class="btn btn-sm mr-1 btn-primary"><i class="fa fa-calendar" aria-hidden="true"></i> Reschedule</button></a> --}}
                                        <a href="democancel/{{$demo->demo_id}}"><button class="btn btn-sm btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Cancel</button></a></td>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-danger" disabled><i class="fa fa-times" aria-hidden="true"></i> Cancel</button></td>
                                    @endif
