                ...
                <div class="content-wrapper">
                    ...
                    <div id="listHeader">
                        ...
                        <button hidden class="btn btn-sm btn-primary" data-toggle="modal"
                            data-target="#makePaymentModal">Make
                            Payment
                        </button>
                    </div>
                    ...
                    <table class="table table-bordered table-responsive ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>$50</td>
                                <td>$150</td>
                                <td>PAY000020230001</td>
                                <td>10-06-2023 10:23:22</td>
                                <td><button class="btn btn-sm btn-primary" data-toggle="modal"
                                        data-target="#makePaymentModal">Pay </button></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>$50</td>
                                <td>$200</td>
                                <td>PAY000020230002</td>
                                <td>03-06-2023 15:24:02</td>
                                <td><button class="btn btn-sm btn-primary" data-toggle="modal"
                                        data-target="#makePaymentModal">Pay </button></td>
                            ...
                            <tr>
                                ...
                                <td>$100</td>
                                <td>$200</td>
                                <td>PAY000020230004</td>
                                <td>01-03-2023 12:23:22</td>
                                <td><button class="btn btn-sm btn-primary" data-toggle="modal"
                                        data-target="#makePaymentModal">Pay </button></td>
                            ...
                            <tr>
                                ...
                                <td>$0</td>
                                <td>$300</td>
                                <td>PAY000020230005</td>
                                <td>12-02-2023 10:23:22</td>
                                <td></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="text-center mt-3">
                    <h4 class="modal-title" id="exampleModalLabel">William</h4>
                    <p>Payment Details</p>
                </div>
                <div class="modal-body">
                    <div class=" row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="" placeholder="Enter Mother's Name"
                                value="Mrs. Hazel" disabled>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="">Subject</label>
                            <select type="text" class="form-control" id="" disabled>
                                <option>--Select--</option>
                                <option selected>Mathematics</option>
                                <option>Chamistry</option>
                    ...
                    <div class=" row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="" value="$50" disabled>
                        </div>
                        <div class="form-group col-md-6">
