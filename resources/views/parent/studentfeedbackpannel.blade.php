                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-wrap">In publishing and graphic design, Lorem ipsum is a placeholder
                                    ...
                                    used as a placeholder before final copy </td>
                ...
                <div class="modal-body">
                    ...
                    <form>
                        <div class=" row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="">Tutor Name<i style="color:red">*</i></label>
                                <select type="text" class="form-control" id="">
                                    <option>--Select--</option>
                                    <option>Mr. Richard</option>
                                    <option>Mrs. Hezal</option>
                                    <option>Mr. Fred</option>
                        ...
                        <a type="button" id="" class="btn btn-sm btn-primary moveRight"
                            href="studentFeedbackPannel.html">Submit</a>
