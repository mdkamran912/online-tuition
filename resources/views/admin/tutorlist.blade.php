...
<body>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="tutorList.html">
                        ...
                        <!-- <div class="collapse" id="form-elements">
                                        <ul class="nav flex-column sub-menu">
                                            <li class="nav-item"> <a class="nav-link" href="tutorList.html">List</a></li>
                                            <li class="nav-item"> <a class="nav-link" href="addTutor.html">Add New</a></li>
                                        </ul>
                                    </div> -->
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="syllabus.html" aria-controls="form-elements">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="addTask.html" aria-controls="form-elements">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="campaign.html" aria-controls="form-elements">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="testQuestion.html" aria-controls="form-elements">
                            <i class="ti-help menu-icon"></i>
                            <span class="menu-title">Test Question</span>
                            <!-- <i class="menu-arrow"></i> -->
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="testAnswer.html" aria-controls="form-elements">
                            <i class="ti-file menu-icon"></i>
                            <span class="menu-title">Test Answer</span>
                            <!-- <i class="menu-arrow"></i> -->
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="attendance.html" aria-controls="form-elements">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="addClass.html" aria-controls="form-elements">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <!-- <h3 class="text-center">List Of Tutors</h3> -->
                    <div id="listHeader">
                        <h3>List Of Tutors</h3>
                        <button hidden class="btn btn-sm btn-primary" data-toggle="modal"
                            data-target="#addTutorModal">Add
                            New Tutor</button>
                    </div>
    ...
    <!-- modal -->
    <div class="modal fade" id="addTutorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="" placeholder="Enter Secondary Mobile">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="">Email<i style="color:red">*</i></label>
                                <input type="email" class="form-control" id="" value="dwaynejohnson@gmail.com" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">Rate<i style="color:red">*</i></i></label>
                                <input type="text" class="form-control" id="" placeholder="Enter Rate">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Hedline<i style="color:red">*</i></label>
                            <input type="text" class="form-control" id="" placeholder="Enter Hedline ">
                        </div>

                        <div class=" row">
                            <div class="form-group col-md-6">
                                <label for="">Details1<i style="color:red">*</i></label>
                                <input type="text" class="form-control" id="" placeholder="Enter Details1">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">Details2</label>
                                <input type="text" class="form-control" id="" placeholder="Enter Details2">
                            </div>
                        </div>
                        <div class=" row">
                            <div class="form-group col-md-6">
                                <label for="">Details3</label>
                                <input type="text" class="form-control" id="" placeholder="Enter Details3">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">Area<i style="color:red">*</i></label>
                                <input type="text" class="form-control" id=""
                                    placeholder="Enter Area Of Your Expertise.">
                            </div>
                        </div>
                        <div class=" row">
                            <div class="form-group col-md-6">
                    ...
                    <a type="button" id="" class="btn btn-sm btn-primary moveRight" href="tutorList.html">Submit</a>
