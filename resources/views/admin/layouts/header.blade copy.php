                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <a class="nav-link dropdown-toggle ml-2" href="#" data-toggle="dropdown" id="profileDropdown">
                            <img src="{{  url('images/avatar/default-profile-pic.png')}}"
                                alt="profile" />
                        </a>
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="form-elements">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{route('admin.reports.student-payments')}}">Student Payments</a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{route('admin.reports.tutor-payments')}}">Tutor Payments</a></li>
                                {{--<li class="nav-item"> <a class="nav-link" href="{{route('admin.topic')}}">Topic</a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{route('admin.batch')}}">Batch</a></li> --}}
                            </ul>
                        </div>
