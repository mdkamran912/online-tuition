        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div id="listHeader">
                        <h3>List Of Campaign</h3>
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addCampaignModal">Add
                            New Campaign</button>
                    </div>
                        ...
                        <table class="table table-hover table-bordered ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>25 Jun 2023</td>
                                    <td>24 Jul 2023</td>
                                    <td>This is new campaign of 2023.</td>
                                </tr>
                                <tr>
                                    <td>1</td>
                                    <td>Camp2023</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3 class="text-center mb-3"><u>Add New Campaign</u></h3>
                    <form>

                        <div class="form-group">
                            <label for="">Code<i style="color:red">*</i></label>
                            <input type="text" class="form-control" id="" placeholder="Enter Campaign Code ">
                        </div>
                        ...
                        <div class=" row">
                            <div class="form-group col-md-6">
                                <label for="">Start Date<i style="color:red">*</i></label>
                                <input type="date" class="form-control" id="">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">End Date<i style="color:red">*</i></label>
                                <input type="date" class="form-control" id="">
                            </div>
                        </div>
                    ...
                    <a type="button" id="" class="btn btn-sm btn-primary moveRight" href="campaign.html">Submit</a>
