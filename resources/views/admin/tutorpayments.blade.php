...
<meta name="csrf-token" content="{{ csrf_token() }}">
        ...
        @endif
            ...
            <div id="listHeader" class="mb-3">
                <h3>Tutor Payment History</h3><br>
            ...
            <script>
                ...
                $(document).ready(function () {
                    $('#payment-search').submit(function (e) {
                        e.preventDefault();
                        const page = 1;
                        const ajaxUrl = '{{ route("admin.tutor-paymentsearch") }}'
                    ...
                    $.ajax({
                        type: 'post',
                        url: '{{ route("admin.tutor-paymentsearch") }}', // Define your route here
                        data: {
