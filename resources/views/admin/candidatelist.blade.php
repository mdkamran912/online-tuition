                ...
                <div class="content-wrapper">
                    <div id="listHeader">
                        ...
                        <button hidden class="btn btn-sm btn-primary" data-toggle="modal"
                            data-target="#addCandidateModal">Add
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3 class="text-center">Add New Candidate</h3>
                    ...
                    <a type="button" id="" class="btn btn-sm btn-primary moveRight" href="candidateList.html">Submit</a>
