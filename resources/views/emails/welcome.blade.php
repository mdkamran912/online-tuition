...
<tr class=""><td class="headline">Welcome to My Choice Tutor!</td></tr>
<tr>
<td>
<center class=""><table cellpadding="0" cellspacing="0" class="" style="margin: 0 auto;" width="75%"><tbody class=""><tr class="">
<td class="" style="color:#444; font-weight: 400;"><br><br>
 <b>Dear {{$user_name}}</b><br><br>
 Welcome aboard! We are thrilled to have you join our institution. As you embark on this exciting academic journey. Our team is always available to support and guide you. Here's to a successful and enriching experience ahead!
 <br>
 <br>
  Your login credentials are provided below:
<br>
<span style="font-weight:bold;">Mobile: &nbsp;</span><span style="font-weight:lighter;" class="">{{$user_mobile}}</span>
 <br>
