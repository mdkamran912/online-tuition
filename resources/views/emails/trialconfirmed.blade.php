...
<tr class=""><td class="headline">Trial Class Confirmed!</td></tr>
<tr>
<td>
<center class=""><table cellpadding="0" cellspacing="0" class="" style="margin: 0 auto;" width="75%"><tbody class=""><tr class="">
<td class="" style="color:#444; font-weight: 400;"><br><br>
 <b>Dear {{$user_name}}</b><br><br>
 Your request for trial class has been accepted and confirmed. As you embark on this exciting academic journey. Our team is always available to support and guide you. Here's to a successful and enriching experience ahead!
 <br>
 <br>
  Trial Class Details:
<br>
<span style="font-weight:bold;">Confirmed Slot: &nbsp;</span><span style="font-weight:lighter;" class="">{{$confirmed_slot}}</span>
 <br>
