...
<tr class=""><td class="headline">Enrollment Successfull!</td></tr>
<tr>
<td>
<center class=""><table cellpadding="0" cellspacing="0" class="" style="margin: 0 auto;" width="75%"><tbody class=""><tr class="">
<td class="" style="color:#444; font-weight: 400;"><br><br>
 <b>Dear {{$user_name}}</b><br><br>
 Thank you for your purchase. As you embark on this exciting academic journey. Our team is always available to support and guide you. Here's to a successful and enriching experience ahead!
 <br>
 <br>
  Enrollment Details:
<br>
<span style="font-weight:bold;">Number Of Classes: &nbsp;</span><span style="font-weight:lighter;" class="">{{$total_classes}}</span>
 <br>
