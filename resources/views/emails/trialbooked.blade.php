...
<tbody style="margin-top: 15px;">
  <tr class="">
<td class="">
<img alt="robot picture" class="" height="60" src="https://mychoicetutor.com/frontendnew/img/logo-mtc.png" width="155">
</td>
</tr>
<tr class=""><td class="headline">Trial Class Booked!</td></tr>
<tr>
<td>
<center class=""><table cellpadding="0" cellspacing="0" class="" style="margin: 0 auto;" width="75%"><tbody class=""><tr class="">
<td class="" style="color:#444; font-weight: 400;"><br><br>
 <b>Dear {{$user_name}}</b><br><br>
 Thanks for booking trial class with us. Please wait for the confirmation. Soon you will get an confirmation email. As you embark on this exciting academic journey. Our team is always available to support and guide you. Here's to a successful and enriching experience ahead!
 <br>
 <br>
  Your preferred slots:
<br>
<span style="font-weight:bold;">Slot 1: &nbsp;</span><span style="font-weight:lighter;" class="">{{$slot_1}}</span>
 <br>
 <span style="font-weight:bold;">Slot 2: &nbsp;</span><span style="font-weight:lighter;" class="">{{$slot_2}}</span>
 <br>
 <span style="font-weight:bold;">Slot 3: &nbsp;</span><span style="font-weight:lighter;" class="">{{$slot_3}}</span>
 <br>
  <span style="font-weight:bold;">Tutor Name: &nbsp;</span><span style="font-weight:lighter;" class="">{{$tutor_name}}</span>
<br><br>
<br></td>
</tr>
</tbody></table></center>
...
<td class="" style="color:#444;
                    ">
<p> For any querry, feel free to contact us @ 07761 975326
