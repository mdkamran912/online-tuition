            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5 class="text-primary">Welcome Back Tutor!</h5>
                                <p class="text-muted">Sign in to continue to "Online Tuition"</p>
                            </div>
                            ...
                            @endif
                            <div class="p-2 mt-4">
                                <form action="{{ url('/tutor-login') }}" method="GET" class="loginForm">
                                    @csrf
                    ...
                    <div class="mt-4 text-center bottom">
                        <p class="mb-0">Don't have an account ? <a href="{{ route('ttr_registration') }}"
                                class="fw-semibold text-primary text-decoration-underline"> Signup </a> </p>
                        <p class="mb-0">Sign in as <a href="{{route('studentlogin')}}"
                                class="fw-semibold text-primary text-decoration-underline"> Student </a> </p>
                    </div>
