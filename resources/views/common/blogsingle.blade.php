            ...
            <nav class="navbar navbar-expand-lg navbar-light foi-navbar">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item active dropdown" hidden>
                            ...
                            <div class="dropdown-menu" aria-labelledby="pagesMenu">
                                ...
                                <a class="dropdown-item" href="blog-single.html">Single blog <span
                    ...
                    <ul class="navbar-nav mt-2 mt-lg-0" hidden>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    ...
                    <section class="blog-post-header">
                        <div class="row">
                            <div class="col-lg-10 offset-lg-1">
                                <p class="blog-post-date">02 APR 2023</p>
                                <h1 class="blog-post-title">Why Do Chemicals React? Kinetics and Thermodynamics</h1>
                            </div>
                        </div>
                    </section>
                    <section class="blog-post-content">
                        <div class="row">
                            <div class="col-12 mb-5">
                                <img src="images/chemicals.jpg" alt="blog details" class="img-fluid">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-10 offset-lg-1">
                        ...
                        <div class="row">
                            <div class="col-12 mb-5">
                                <img src="images/beakers.jpg" alt="blog details" class="img-fluid">
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="row">
                            <div class="col-lg-8 offset-lg-2">
                                ...
                                <div class="blog-post-author-info media">
                                    <img src="images/avatar/avatar_6.jpg" alt="avatar"
                        ...
                        <div class="row">
                            <div class="col-md-4 related-post">
                                <div class="related-post-thumbnail-wrapper">
                                    <img src="images/chemical2.jpg" alt="related post" width="236" height="160">
                                    <span class="blog-post-badge">Trending</span>
                                </div>
                                <p class="post-published-date">02 APR 2023</p>
                                <h4 class="post-tite">Lorem ipsum dolor sit amet, consectetur</h4>
                            </div>
                            <div class="col-md-4 related-post">
                                <div class="related-post-thumbnail-wrapper">
                                    <img src="images/phy_pendulum.jpeg" alt="related post" width="236"
                                        height="160">
                                    <span class="blog-post-badge">Trending</span>
                                </div>
                                <p class="post-published-date">24 APR 2023</p>
                                <h4 class="post-tite">Lorem ipsum dolor sit amet, consectetur</h4>
                            </div>
                            <div class="col-md-4 related-post">
                                <div class="related-post-thumbnail-wrapper">
                                    <img src="images/skeleten.webp" alt="related post" width="236" height="160">
                                    <span class="blog-post-badge">Trending</span>
                                </div>
                                <p class="post-published-date">30 APR 2023</p>
                                <h4 class="post-tite">Lorem ipsum dolor sit amet, consectetur</h4>
                            </div>
                        </div>
                    </section>
    ...
    <footer class="foi-footer text-white">
        <div class="container">
            ...
            <div class="row footer-widget-area">
                ...
                <div class="col-md-3 mt-3 mt-md-0">
                    <p>
                        &copy; ABC Company Limited. 2023 <a href="https://www.bootstrapdash.com/" target="_blank"
                            rel="noopener noreferrer" class="text-reset">Denova Glosoft Limited</a>.
                    </p>
...
<!-- Mirrored from bootstrapdash.com/demo/foi-app-landing-page/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Jun 2023 11:13:20 GMT -->
