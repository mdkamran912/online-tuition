                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="p-2 mt-4">
                                        <form action="{{Route('student_registration_form')}}" method="POST" id="regisForm">
                                            ...
                                            <div class="mb-3">
                                                <label for="username" class="form-label">Mobile No. <span
                                                        class="text-danger">*</span></label>
                                            ...
                                            <div id="password" class="p-3 bg-light mb-2 rounded">
                            ...
                            <div class="mt-4 text-center">
                                <p class="mb-0">Already have an account ? <a href="{{route('studentlogin')}}"
                                    class="fw-semibold text-primary text-decoration-underline"> Signin </a> </p>
                                    <p class="mb-0">Tutor Registration ? <a href="{{route('ttr_registration')}}"
