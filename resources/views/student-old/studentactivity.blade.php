                    ...
                    <table class="table table-bordered table-responsive">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td><b>Chemistry</b>
                                    <p class="text-wrap">Finding the pH of the following samples by using pH
                                ...
                                <td>Mrs. Isabella</td>
                                <td>
                                    <a href="#"><i class="fa fa-paperclip" aria-hidden="true"></i><b>View </b></a>
                                </td>
                            ...
                            <tr>
                                <td>2</td>
                                <td><b>Physics</b>
                                    <p class="text-wrap">To determine the resistivity of two / three wires by plotting a
                                        graph for potential difference versus current.</p>
                            ...
                            <tr>
                                <td>3</td>
                                <td><b>Mathematics</b>
                                    <p class="text-wrap">To develop Heron's formula for the area of a triangle.</p>
                            ...
                            <tr>
                                <td>4</td>
                                <td><b>English</b>
                                    <p class="text-wrap">Write an article in 100-150 words on <q>Importance of
                                            Morning Walk</q>. You are Amit/Anita. Use the following clues
                                        :</p>
                                    <ul>
                                        <li>makes you rise early</li>
                                        <li>fresh air</li>
                                        <li>blood rushes through your body</li>
                                        <li>energy for the day</li>
                                        <li>hungry for breakfast</li>
                                        <li>good for studies</li>
                                        <li>all day active</li>
                                    </ul>
